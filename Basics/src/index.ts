...
function render(document: any) {
  // needs annotation when it's a parameter
...
//* Basic Generics
function createPairs<str, num>(v1: str, v2: num): [str, num] {
    return [v1, v2];
}

console.log(createPairs<string, number>("Hello", 500));
...
const value2 = new NamedValue<string>('userName');
